...
Write-Info "Baseline and UX package lists come from the active profile in config/."
Write-Warn "Network-capable and remote-access packages are intentionally excluded from the baseline and UX installers."
