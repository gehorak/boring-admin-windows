...
Write-Info ("Configured computer name : {0}" -f $hostIdentity.computerName)
Write-Info ("Configured time zone     : {0}" -f $hostIdentity.timeZone)
Write-Info ("Configured system locale : {0}" -f $hostIdentity.systemLocale)
